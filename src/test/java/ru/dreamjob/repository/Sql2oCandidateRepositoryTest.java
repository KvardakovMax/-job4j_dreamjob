...
class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        assertThat(candidate).usingRecursiveComparison().isEqualTo(savedCandidate);
    }
    ...
    @Test
    public void whenDeleteThatGetEmptyOptional() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "name", "description", creationDate, 1, file.getId()));
    ...
    public void whenUpdateThenGetUpdated() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "name", "description", creationDate, 1, file.getId()));
        var updatedCandidate = new Candidate(candidate.getId(), "new name", "new description", creationDate.plusDays(1), 2, file.getId());
        ...
        assertThat(updatedCandidate).usingRecursiveComparison().isEqualTo(savedCandidate);
    }
